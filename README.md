...
![Skill Icons](https://skills.syvixor.com/api/icons?i=reactjs,reactrouter,vite,tailwindcss,typescript,javascript,nodejs,npm,pnpm,expressjs,axios,postman,json,rest,nodemon,eslint,typescripteslint,prettier,upstash,redis,markdown,html,css,sql,mongodb,docker,windows,vercel,git,github,githubcopilot,visualstudiocode,cursor,claudeai,notion&perline=8&radius=36)
